...
train_pipeline = [
    ...
    # VOC: dict(type='GenerateEdge', edge_width=4),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path='JPEGImagesPerson', seg_map_path='SegmentationClassPerson'),
        ann_file='ImageSets/Segmentation/train_person.txt',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path='JPEGImagesPerson', seg_map_path='SegmentationClassPerson'),
        ann_file='ImageSets/Segmentation/val_person.txt',
